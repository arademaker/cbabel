...
public class CarSimulator extends Canvas implements Runnable, CarSpeed{
    ...
    private double throttle = 0.0;        //throttle setting 0.10
    private int speed = 0;                //speed 0 .. 120 mph!
    private int distance = 0;             //miles*10
    private int brakepedal = 0;           // brake setting 0..10
    Thread engine=null;
